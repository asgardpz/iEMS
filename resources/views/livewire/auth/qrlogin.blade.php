...
<head>
  ...
  <style>
    ...
    .ev-icon { width: 320px; height: 160px; margin-bottom: 16px; object-fit: contain; }
    .left-title { text-align: center; line-height: 1.1; margin-top: 8px; }
    .left-title .line { font-weight: 700; font-size: 48px; color: #7ef3a0; letter-spacing: 0.3px; }
    .version { position: absolute; left: 24px; bottom: 16px; font-size: 12px; color: #ffffff; }
    .right {
      width: 40%;
      background: #ffffff;
      display: flex;
    ...
    .panel { width: 360px; text-align: center; }
    .welcome { font-size: 24px; font-weight: 600; color: #1f2937; margin-bottom: 32px; }
    ...
    .row a { color: #4b5563; text-decoration: none; }
